package nam.tran.architechture.view.main.activity.season.adapter;
...
public class SoccerSeasonAdapter extends DataBoundListAdapter<SoccerSeasonModel,AdapterSoccerSeasonBinding> {

    private final DataBindingComponent dataBindingComponent;
    private final OnItemSoccerSeasonClick onItemSoccerSeasonClick;

    public SoccerSeasonAdapter(DataBindingComponent dataBindingComponent, OnItemSoccerSeasonClick onItemSoccerSeasonClick) {
