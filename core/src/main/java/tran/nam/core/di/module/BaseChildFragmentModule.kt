 ...
 * must provide a concrete implementation of the child [Fragment] and named
 * [.CHILD_FRAGMENT].
 *
 *
 * Note that a different [javax.inject.Named] for the [Fragment] is required in order to
